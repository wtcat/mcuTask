...
function(add_llext_target target_name)
  ...
  set(zephyr_flags
      "$<TARGET_PROPERTY:common_interface,INTERFACE_COMPILE_OPTIONS>"
  )
  ...
  target_compile_definitions(${llext_lib_target} PRIVATE
    $<TARGET_PROPERTY:common_interface,INTERFACE_COMPILE_DEFINITIONS>
    LL_EXTENSION_BUILD
  )
  ...
  target_include_directories(${llext_lib_target} PRIVATE
    $<TARGET_PROPERTY:common_interface,INTERFACE_INCLUDE_DIRECTORIES>
  )
  target_include_directories(${llext_lib_target} SYSTEM PUBLIC
    $<TARGET_PROPERTY:common_interface,INTERFACE_SYSTEM_INCLUDE_DIRECTORIES>
  )
