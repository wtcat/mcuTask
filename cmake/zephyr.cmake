...
function(zephyr_sources)
  ...
  function(zephyr_system_include_directories)
    target_include_directories(common_interface SYSTEM INTERFACE ${ARGV})
  endfunction()
  ...
  function(zephyr_libc_link_libraries)
    set_property(TARGET common_interface APPEND PROPERTY LIBC_LINK_LIBRARIES ${ARGV})
  endfunction()
  ...
  function(zephyr_library_compile_options item)
    ...
    # the command line than the flags from common_interface because
