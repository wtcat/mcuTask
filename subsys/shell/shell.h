...
#include <subsys/shell/shell_types.h>
#include <subsys/shell/shell_history.h>
#include <subsys/shell/shell_fprintf.h>
#include <subsys/shell/shell_log_backend.h>
#include <subsys/shell/shell_string_conv.h>
...
enum shell_signal {
	...
	SHELL_SIGNAL_TXDONE  = BIT(3), /* TXDONE must be last one before SHELL_SIGNALS */
	SHELL_SIGNALS = 0xF
};
