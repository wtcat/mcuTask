...
#ifndef SUBSYS_SD_SPEC_H_
#define SUBSYS_SD_SPEC_H_
...
#define _SD_SPEC_MHZ(n) (_SD_SPEC_KHZ(n) * 1000ul)
#define _SD_SPEC_KHZ(n) ((n) * 1000)
...
enum sd_r1_status {
	...
	SD_R1_ERR_FLAGS =
		(SD_R1_AUTH_ERR | SD_R1_ERASE_SKIP | SD_R1_CSD_OVERWRITE | SD_R1_ERR |
		 SD_R1_CC_ERR | SD_R1_ECC_FAIL | SD_R1_ILLEGAL_CMD | SD_R1_CRC_ERR |
		 SD_R1_UNLOCK_FAIL | SD_R1_WP_VIOLATION | SD_R1_ERASE_PARAM |
		 SD_R1_ERASE_SEQ_ERR | SD_R1_BLOCK_LEN_ERR | SD_R1_ADDR_ERR | SD_R1_OUT_OF_RANGE),
	SD_R1ERR_NONE = 0,
};
...
enum hs_max_data_rate {
	HS_UNSUPPORTED = 0,
	HS_MAX_DTR = _SD_SPEC_MHZ(50),
};

/* Maximum data rate possible for SD uhs cards */
enum uhs_max_data_rate {
	UHS_UNSUPPORTED = 0,
	UHS_SDR12_MAX_DTR = _SD_SPEC_MHZ(25),
	UHS_SDR25_MAX_DTR = _SD_SPEC_MHZ(50),
	UHS_SDR50_MAX_DTR = _SD_SPEC_MHZ(100),
	UHS_SDR104_MAX_DTR = _SD_SPEC_MHZ(208),
	UHS_DDR50_MAX_DTR = _SD_SPEC_MHZ(50),
};
...
enum sdhc_clock_speed {
	SDMMC_CLOCK_400KHZ = _SD_SPEC_KHZ(400),
	SD_CLOCK_25MHZ = _SD_SPEC_MHZ(25),
	SD_CLOCK_50MHZ = _SD_SPEC_MHZ(50),
	SD_CLOCK_100MHZ = _SD_SPEC_MHZ(100),
	SD_CLOCK_208MHZ = _SD_SPEC_MHZ(208),
	MMC_CLOCK_26MHZ = _SD_SPEC_MHZ(26),
	MMC_CLOCK_52MHZ = _SD_SPEC_MHZ(52),
	MMC_CLOCK_DDR52 = _SD_SPEC_MHZ(52),
	MMC_CLOCK_HS200 = _SD_SPEC_MHZ(200),
	MMC_CLOCK_HS400 = _SD_SPEC_MHZ(200), /* Same clock freq as HS200, just DDR */
};
