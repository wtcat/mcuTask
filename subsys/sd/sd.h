...
#ifndef SUBSYS_SD_SD_H_
#define SUBSYS_SD_SD_H_
...
#define CONFIG_SDHC_BUFFER_ALIGNMENT RTE_CACHE_LINE_SIZE
#endif
 ...
 */
#ifndef CONFIG_SD_BUFFER_SIZE
#define CONFIG_SD_BUFFER_SIZE 512
#endif

#if CONFIG_SDHC_BUFFER_ALIGNMENT < 4
# error "CONFIG_SDHC_BUFFER_ALIGNMENT must be >= 4"
#endif
...
struct sd_card {
	 ...
	 */
	uint8_t card_buffer[CONFIG_SD_BUFFER_SIZE] __rte_aligned(
		CONFIG_SDHC_BUFFER_ALIGNMENT); /* Card internal buffer */
};
