...
add_subdirectory_ifdef(CONFIG_FILEX ${SRCTREE_DIR}/addons)

# Network security and crypto components
add_subdirectory(${SRCTREE_DIR}/crypto_libraries)
add_subdirectory(${SRCTREE_DIR}/nx_secure)

# Utility components
add_subdirectory_ifdef(CONFIG_FILEX ${SRCTREE_DIR}/utility)

# Link layer
add_subdirectory(${SRCTREE_DIR}/tsn)

# If the user provided an override, copy it to the custom directory
if (NOT NX_USER_FILE)
    message(STATUS "Using default nx_user_config.h file")
    set(NX_USER_FILE ${SRCTREE_DIR}/../configs/nx_user_config.h)
else()
